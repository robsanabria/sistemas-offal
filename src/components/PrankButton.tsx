...
const CATEGORY_OVERRIDES: Record<string, string> = {
  ...
  // Tanda 2026-08
  'eeeehh-bendita': 'famosos', 'bielsa-dale': 'futbol', 'ruido-de-mate': 'oficina',
  'cucu-cucurella': 'memes', 'spiderman-meme': 'memes', 'cerra-el-orto': 'memes',
  'mucha-ropa': 'memes', 'papoi': 'memes', 'gemidinho': 'memes',
  'jorge-suspenso': 'memes', 'la-cola-no': 'memes',
  'piuw': 'fx', 'sonido-de-grillo': 'fx', 'ronquidos': 'fx', 'dame-un-eructo': 'fx',
}
...
export default function PrankButton() {
  ...
  const sounds = [
    ...
    '/mucha-ropa.mp3',
    '/papoi.mp3',
    '/sonido-de-grillo.mp3',
    '/hasta-la-proxima.mp3',
    '/gemidinho.mp3',
    '/dios-mio-salvame.mp3',
    '/bielsa-dale.mp3',
    '/ruido-de-mate.mp3',
    '/hola-sofi.mp3',
    '/ronquidos.mp3',
